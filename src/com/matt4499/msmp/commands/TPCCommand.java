...
public class TPCCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if(!player.hasPermission("staff.tpc")) {
            ...
            if(args.length < 2) {
                player.sendMessage(Main.hex("#dc143c&lSTAFF &7➠ #dc143cUsage: /tpc <X> <Y> <Z>"));
                return true;
            }
            ...
            player.teleport(loc);
            player.sendMessage(Main.hex("#dc143c&lSTAFF &7➠ &aTeleported to &7"+loc.getBlockX()+" "+loc.getBlockY()+" "+loc.getBlockZ()));
